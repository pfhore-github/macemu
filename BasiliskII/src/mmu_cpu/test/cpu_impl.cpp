...
BOOST_FIXTURE_TEST_SUITE(C_TST, InitFix)
...
BOOST_FIXTURE_TEST_SUITE(C_not, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) { BOOST_TEST(DO_NOT_B(0x12) == (0x12 ^ 0xff)); }
...
BOOST_AUTO_TEST_CASE(value) {
    BOOST_TEST(DO_NOT_W(0x1234) == (0x1234 ^ 0xffff));
}
BOOST_AUTO_TEST_CASE(vcx) {
    regs.v = regs.c = regs.x = true;
    DO_NOT_W(0);
...
BOOST_AUTO_TEST_SUITE(Long)
BOOST_AUTO_TEST_CASE(value) { BOOST_TEST(DO_NOT_L(0x12345678) == ~0x12345678); }
...
BOOST_FIXTURE_TEST_SUITE(C_or, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) {
...
BOOST_FIXTURE_TEST_SUITE(c_and, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) {
...
BOOST_FIXTURE_TEST_SUITE(C_xor, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) {
...
BOOST_FIXTURE_TEST_SUITE(C_add, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) {
...
BOOST_FIXTURE_TEST_SUITE(C_sub, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) {
...
BOOST_FIXTURE_TEST_SUITE(C_cmp, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(v1) {
    DO_CMP_B(0x7f, 0xff);
    BOOST_TEST(regs.v);
...
BOOST_FIXTURE_TEST_SUITE(C_asr, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
...
BOOST_FIXTURE_TEST_SUITE(C_asl, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) {
...
BOOST_FIXTURE_TEST_SUITE(C_lsl, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) {
...
BOOST_FIXTURE_TEST_SUITE(C_roxr, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
...
BOOST_FIXTURE_TEST_SUITE(C_roxl, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_DATA_TEST_CASE(value, bdata::xrange(2), value) {
    regs.x = value;
...
BOOST_FIXTURE_TEST_SUITE(C_ror, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) {
...
BOOST_FIXTURE_TEST_SUITE(C_rol, InitFix)
BOOST_AUTO_TEST_SUITE(Byte)
BOOST_AUTO_TEST_CASE(value) {
