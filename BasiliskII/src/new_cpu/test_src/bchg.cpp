	...
	)
{
	...
	xcpu.A[dst] = 0x1000; 
	xcpu.D[sc] = 3;
	test_cpu({ (uint16_t)(0000520 | sc << 9 | dst) });
	BOOST_TEST( test_read8(0x1000) == 0x80 );
}
	...
	)
{
	...
	xcpu.A[dst] = 0x1000; 
	xcpu.D[sc] = 3;
	test_cpu({ (uint16_t)(0000530 | sc << 9 | dst) });
	BOOST_TEST( test_read8(0x1000) == 0x80 );
	...
	)
{
	...
	xcpu.D[sc] = 3;
	test_cpu({ (uint16_t)(0000540 | sc << 9 | dst) });
	BOOST_TEST( test_read8(0x1000) == 0x80 );
	...
	)
{
	...
	xcpu.A[dst] = 0x1000; 
	xcpu.D[sc] = 3;
	test_cpu({ (uint16_t)(0000550 | sc << 9 | dst), 0x10 });
	...
	)
{
	...
	xcpu.D[0] = 0x10;
	xcpu.D[sc] = 3;
	test_cpu({ (uint16_t)(0000560 | sc << 9 | dst), 0x0830 });
	...
	)
{
	test_write8(0x1000, 0x80 | 1 << 3);	
	xcpu.D[sc] = 3;
	test_cpu({ (uint16_t)(0000570 | sc << 9 ), 0x1000 });
	BOOST_TEST( test_read8(0x1000) == 0x80 );
}
	...
	)
{
	test_write8(0x1000, 0x80 | 1 << 3);	
	xcpu.D[sc] = 3;
	test_cpu({ (uint16_t)(0000571 | sc << 9 ), 0, 0x1000 });
	BOOST_TEST( test_read8(0x1000) == 0x80 );
}
	...
	)
{
	test_write8(0x1000, 0x80 | 1 << 3);	
	xcpu.A[dst] = 0x1000; 
	test_cpu({ (uint16_t)(0004120 | dst), 3 });
	BOOST_TEST( test_read8(0x1000) == 0x80 );
}
	...
	)
{
	test_write8(0x1000, 0x80 | 1 << 3);	
	xcpu.A[dst] = 0x1000; 
	test_cpu({ (uint16_t)(0004130 | dst), 3 });
	BOOST_TEST( test_read8(0x1000) == 0x80 );
	BOOST_TEST( xcpu.A[dst] == (dst == 7 ? 0x1002 : 0x1001 ) );
}
	...
	)
{
	test_write8(0x1000, 0x80 | 1 << 3);	
	xcpu.A[dst] = dst == 7 ? 0x1002 : 0x1001; 
	test_cpu({ (uint16_t)(0004140 | dst), 3 });
	BOOST_TEST( test_read8(0x1000) == 0x80 );
	BOOST_TEST( xcpu.A[dst] == 0x1000 );
}
	...
	)
{
	test_write8(0x1010, 0x80 | 1 << 3);	
	xcpu.A[dst] = 0x1000; 
	test_cpu({ (uint16_t)(0004150 | dst), 3, 0x10 });
	BOOST_TEST( test_read8(0x1010) == 0x80 );
}
	...
	)
{
	...
	xcpu.A[dst] = 0x1000;
	xcpu.D[0] = 0x10;
	test_cpu({ (uint16_t)(0004160 | dst), 3, 0x0830 });
	BOOST_TEST( test_read8(0x1040) == 0x80 );
}
	...
	)
{
	xcpu.D[dst] = 1 | 1 << 22;
	xcpu.D[sc] = 22;
	test_cpu({ (uint16_t)( 0000500 | sc << 9 | dst) });
	if( dst == sc ) {
...
{
	xcpu.D[dst] = 1 | 1 << 22;
	test_cpu({ (uint16_t)(0004100 | dst), 22});
	xcpu.D[dst] = 1;
}
BOOST_AUTO_TEST_SUITE_END();
