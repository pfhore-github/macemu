...
BOOST_FIXTURE_TEST_SUITE(bfextu_reg, fixture);
BOOST_AUTO_TEST_CASE(result)
{
	xcpu.X = xcpu.N = xcpu.Z = xcpu.V = xcpu.C = true;
	xcpu.D[0] = 0x12345678;
	test_cpu({ 0164700, (uint16_t)(8 << 6 | 4) });
...
BOOST_AUTO_TEST_CASE(offset_reg)
{
	xcpu.D[1] = 8;
	xcpu.D[0] = 0x12345678;
	test_cpu({ 0164700, (uint16_t)(1 << 11 | 1 << 6 | 4) });
	BOOST_TEST( xcpu.D[0] == 3 );
}
...
BOOST_AUTO_TEST_CASE(width_reg)
{
	xcpu.D[1] = 4;
	xcpu.D[0] = 0x12345678;
	test_cpu({ 0164700, (uint16_t)(1 << 5 | 8 << 6 | 1) });
	BOOST_TEST( xcpu.D[0] == 3 );
}
...
BOOST_AUTO_TEST_CASE(wrap)
{
	xcpu.D[1] = 4;
	xcpu.D[0] = 0x12345673;
	test_cpu({ 0164700, (uint16_t)( 28 << 6 | 8) });
...
BOOST_AUTO_TEST_CASE(negative_offset)
{
	xcpu.D[1] = -4;
	xcpu.D[0] = 0x12345673;
	test_cpu({ 0164700, (uint16_t)(1 << 11 | 1 << 6 | 8) });
	BOOST_TEST( xcpu.D[0] == 0x31 );
}
	...
	)
{
	...
	test_cpu({ (uint16_t)(0164700 | dst), (uint16_t)(8 << 6 | 4) });
	BOOST_TEST( xcpu.D[0] == 3 );
}

BOOST_AUTO_TEST_SUITE_END();

BOOST_FIXTURE_TEST_SUITE(bfextu_mem, fixture);
BOOST_AUTO_TEST_CASE(in1)
{
	test_write8(0x1000, 0x12 );	
	xcpu.A[0] = 0x1000;
	test_cpu({ 0164720, (uint16_t)(4 << 6 | 4) });
...
BOOST_AUTO_TEST_CASE(in2)
{
	...
	xcpu.A[0] = 0x1000;
	test_cpu({ 0164720, (uint16_t)(4 << 6 | 8) });
...
BOOST_AUTO_TEST_CASE(in3)
{
	...
	xcpu.A[0] = 0x1000;
	test_cpu({ 0164720, (uint16_t)(4 << 6 | 16) });
...
BOOST_AUTO_TEST_CASE(in4)
{
	test_write32(0x1000, 0x12345678 );	
	xcpu.A[0] = 0x1000;
	test_cpu({ 0164720, (uint16_t)(4 << 6 | 24) });
	...
	)
{
	...
	xcpu.A[0] = 0x1000;
	test_cpu({ 0164720, (uint16_t)(8 << 6 | 4) });
	BOOST_TEST( xcpu.N == n );
}
...
BOOST_AUTO_TEST_CASE(offset_reg)
{
	...
	test_write16(0x1000, 0x1234 );
	xcpu.A[0] = 0x1000;
	test_cpu({ 0164720, (uint16_t)(1 << 11 | 1 << 6 | 4) });
	BOOST_TEST( xcpu.D[0] == 3 );
}
...
BOOST_AUTO_TEST_CASE(width_reg)
{
	...
	test_write16(0x1000, 0x1234 );
	xcpu.A[0] = 0x1000;
	test_cpu({ 0164720, (uint16_t)(1 << 5 | 8 << 6 | 1) });
	BOOST_TEST( xcpu.D[0] == 3 );
}
...
BOOST_AUTO_TEST_CASE(negative_offset)
{
	...
	test_write16(0x1000, 0x1234 );
	xcpu.A[0] = 0x1001;
	test_cpu({ 0164720, (uint16_t)(1 << 11 | 1 << 6 | 8) });
	BOOST_TEST( xcpu.D[0] == 0x23 );
}
	...
	)
{
	test_write8(0x1000, 0x12 );	
	xcpu.A[dst] = 0x1000;
	test_cpu({ (uint16_t)(0164720 | dst), (uint16_t)(4 << 6 | 4) });
	...
	)
{
	...
	xcpu.A[dst] = 0x1000;
	test_cpu({ (uint16_t)(0164750 | dst), (uint16_t)(4 << 6 | 4), 0x10 });
	BOOST_TEST( xcpu.D[0] == 0x2 );
}
	...
	)
{
	...
	xcpu.A[dst] = 0x1000;
	xcpu.D[0] = 0x10;
	test_cpu({ (uint16_t)(0164760 | dst), (uint16_t)(4 << 6 | 4), 0x0830 });
	BOOST_TEST( xcpu.D[0] == 0x2 );
}

BOOST_AUTO_TEST_CASE(xxxw) {
	test_write8(0x1000, 0x12 );	
	test_cpu({ 0164770, (uint16_t)(4 << 6 | 4), 0x1000 });
	BOOST_TEST( xcpu.D[0] == 0x2 );
}

BOOST_AUTO_TEST_CASE(xxxl) {
	test_write8(0x1000, 0x12 );	
	test_cpu({ 0164771, (uint16_t)(4 << 6 | 4), 0, 0x1000 });
	BOOST_TEST( xcpu.D[0] == 0x2 );
}

BOOST_AUTO_TEST_CASE(d16pc) {
	test_write8(0x14, 0x12 );	
	test_cpu({ 0164772, (uint16_t)(4 << 6 | 4), 0x10 });
	BOOST_TEST( xcpu.D[0] == 0x2 );
}
...
BOOST_AUTO_TEST_CASE(d8pcxn) {
	...
	xcpu.D[0] = 0x10;
	test_cpu({ 0164773, (uint16_t)(4 << 6 | 4), 0x0830 });
	BOOST_TEST( xcpu.D[0] == 0x2 );
}
