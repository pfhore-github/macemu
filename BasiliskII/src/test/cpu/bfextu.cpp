...
{
	cpu.R[2] = 0x12345678;
	test_cpu({ 0164702, (uint16_t)(8 << 6 | 4) });
	BOOST_TEST( cpu.R[0] == 3 );
}
...
BOOST_DATA_TEST_CASE(ea_test, ea_control, ea) {
	test_ea_b(cpu, { 0164700, (uint16_t)(4 << 6 | 4) } , 0x12, ea, 0x12 );
	BOOST_TEST( cpu.R[0] == 0x2 );
}
