...
// $032D4-, $A8234
const MOTHERBOARD_TABLE_T motherboards[13] = {
	// GLUE
	{
		0x32D4,
...
const MACHINE_TABLE_T old_machines[] = {
	{ // IIx
		...
		&via_data[0], &via_data[7], 0, 0xB33D2, 0xB2BD2, 0, 0, 0x0000
	},
	{ // SE/30
		0x036D0,
	...
	{ // IIci
		...
		&via_data[1], nullptr, 0, 0xB33D2, 0xB2BD2, 0, 0, 0x0000
	},
	{ // IIci with PGC
		0x037A8,
		&motherboards[1], 0, 0x3C54, 0x3D64, 0xDC00, 0x05, 5, 0x3FFF, 1, 0, 
	...
	{ // PowerBook 170
		...
		&via_data[5], &via_data[11], 0xBCB22, 0xB33D2, 0xB2BEC, 0xB43D2, 0, 0x0000
	},
	{ // PowerBook 180
		0xA8180,
		&motherboards[8], 8, 0xA876E, 0xA78F4, 0xDD00, 0x1B, 12, 0x3FFF, 4, 0, 
		0x00405F3F, 0x213902, 0x56000000, 0x12000000,
		&via_data[5], &via_data[11], 0xBCC36, 0xB33D2, 0xB2BEC, 0xB47B4, 0, 0x0000
	},
	{ // Genaric GLUE
		0x039E8,
	...
	{ // Genaric MDU
		...
		0, 0, 0, 0,
		&via_data[1], &via_data[8], 0, 0xB33D2, 0xB2BD2, 0, 0, 0x0000
	},
	{ // Genaric OSS
		0x03A78,
	...
	{ // Genaric V8
		...
		0, 0, 0, 0,
		&via_data[2], nullptr, 0, 0xB341E, 0xB2C06, 0, 0, 0x0000
	},
	{ // Genaric Jaws
		0x03B08,
		&motherboards[5], 5, 0x3C96, 0x03DC4, 0xDD00, 0xFD, 9, 0x3FFF, 2, 0, 
		0, 0x00010002, 0, 0,
		&via_data[6], &via_data[11], 0, 0xB33D2, 0xB2BEC, 0xB43D2, 0, 0x0000
	},
	{ // Unknown
		0xA8912,
		&motherboards[12], 0, 0, 0, 0, 0xFD, 0, 0xFFFF, 1, 0, 
		0, 0, 0, 0,
		nullptr, nullptr, 0, 0xB33D2, 0, 0, 0, 0x0000
	},
};
const MACHINE_TABLE_T new_machines[] = {
	{
		// PowerBook Duo 210
		0xA7A30,
		&motherboards[6], 6, 0xA8738, 0xA87A4, 0xDD00, 0x17, 10, 0x3FFF, 4, 0, 
		0x773F, 0x00130112, 0x56000000, 0,
		&via_data[12], nullptr, 0x8C8BA, 0xB33F8, 0xB2BEC, 0xB44C6, 0, 0x1004
	},
	{
		// PowerBook Duo 230
		0xA7A78,
		...
		0x773F, 0x00130112, 0x56000000, 0,
		&via_data[12], nullptr, 0x8C8BA, 0xB33F8, 0xB2BEC, 0xB44C6, 0, 0x1005
	},
	{
		// PowerBook Duo 270c
		0xA7AC0,
		...
		0x773F, 0x00130112, 0x56000000, 0,
		&via_data[12], nullptr, 0x8C8BA, 0xB33F8, 0xB2BEC, 0xB450C, 0, 0x1002
	},
	{
		// unused
		0xA7B08,
		...
		&via_data[13], nullptr, 0x8CC64, 0xB341E, 0xB2C06, 0, 0, 0
	},
	{
		// LCIII
		0xA7B50,
		...
		&via_data[13], nullptr, 0x8CC64, 0xB341E, 0xB2C06, 0, 0, 0x1
	},
	{
		// LCIII+
		0xA7B98,
		...
		&via_data[13], nullptr, 0x8CC64, 0xB341E, 0xB2C06, 0, 0, 0x3
	},
	{
		// Unused
		0xA7BE0,
		...
		&via_data[13], nullptr, 0x8CC64, 0xB341E, 0xB2C06, 0, 0, 0x2000
	},
	{
		// unused
		0xA7C28,
		...
		0x2080773F, 0x00403926, 0, 0,
		&via_data[13], nullptr, 0x8CC64, 0xB341E, 0xB2C06, 0, 0, 0x2001
	},
	{
		// unused
		0xA7C70,
		...
		0x2080773F, 0x00403926, 0, 0,
		&via_data[13], nullptr, 0x8CC64, 0xB341E, 0xB2C06, 0, 0, 0x2002
	},
	{
		// unused
		0xA7CB8,
		&motherboards[7], 7, 0xA875C, 0xA87B4, 0xDC00, 0x16, 11, 0x3FFF, 4, 0, 
		0x2080773F, 0x00403926, 0, 0,
		&via_data[13], nullptr, 0x8CC64, 0xB341E, 0xB2C06, 0, 0, 0x2003
	},
	{
		// Quadra 605(20MHz)
		0xA7D90,
		...
		&via_data[15], &via_data[16], 0x8CC92, 0xB3444, 0xB2C06, 0, 0, 0x2224
	},
	{
		// Quadra 605(25MHz)
		0xA7DD8,
		...
		0x0500183F, 0x23804926, 0, 0,
		&via_data[15], &via_data[16], 0x8CC92, 0xB3444, 0xB2C06, 0, 0, 0x2225
	},
	{
		// Quadra 605(30MHz)
		0xA7E20,
		...
		0x0500183F, 0x23804926, 0, 0,
		&via_data[15], &via_data[16], 0x8CC92, 0xB3444, 0xB2C06, 0, 0, 0x2226
	},
	{
		// LC520
		0xA7D00,
		...
		&via_data[14], nullptr, 0x8CC92, 0xB3444, 0xB2C06, 0, 0, 0x0100
	},
	{
		// LC550
		0xA7D48,
		...
		0x0000773F, 0x1B404926, 0, 0,
		&via_data[14], nullptr, 0x8CC92, 0xB3444, 0xB2C06, 0, 0, 0x0101
	},
	{
		// unused
		0xA7E68,
		...
		&via_data[15], &via_data[16], 0x8CC92, 0xB3444, 0xB2C06, 0, 0, 0x2231
	},
	{
		// unused
		0xA7EB0,
		...
		0x0580181F, 0x23804926, 0, 0,
		&via_data[15], &via_data[16], 0x8CC92, 0xB3444, 0xB2C06, 0, 0, 0x2232
	},
	{
		// LC630 #1
		0xA7EF8,
		...
		&via_data[15], &via_data[16], 0xA47C2, 0xB3444, 0xB2C06, 0, 0xA71C0, 0x2252
	},
	{
		// LC630 #2
		0xA7F40,
		&motherboards[10], 9, 0x03D22, 0xA8834, 0xDC80, 0x5C, 13, 0x3FFF, 4, 1,
		0x4180183F, 0x4B807926, 0, 0,
		&via_data[15], &via_data[16], 0xA47C2, 0xB3444, 0xB2C06, 0, 0xA71C0, 0x2253
	},
	{
		// LC630 #3
		0xA7F88,
		&motherboards[10], 9, 0x03D22, 0xA8834, 0xDC80, 0x5C, 13, 0x3FFF, 4, 1,
		0x4180183F, 0x4B807926, 0, 0,
		&via_data[15], &via_data[16], 0xA47C2, 0xB3444, 0xB2C06, 0, 0xA71C0, 0x2250
	},
	{
		// LC630 #4
		0xA7FD0,
		&motherboards[10], 9, 0x03D22, 0xA8834, 0xDC80, 0x5C, 13, 0x3FFF, 4, 1,
		0x4180183F, 0x4B807926, 0, 0,
		&via_data[15], &via_data[16], 0xA47C2, 0xB3444, 0xB2C06, 0, 0xA71C0, 0x2256
	},
	{
		// LC630 #5
		0xA8018,
		&motherboards[10], 9, 0x03D22, 0xA8834, 0xDC80, 0x5C, 13, 0x3FFF, 4, 1,
		0x4180183F, 0x4B807926, 0, 0,
		&via_data[15], &via_data[16], 0xA47C2, 0xB3444, 0xB2C06, 0, 0xA71C0, 0x2257
	},
	{
		// LC630 #6
		0xA8060,
		&motherboards[10], 9, 0x03D22, 0xA8834, 0xDC80, 0x5C, 13, 0x3FFF, 4, 1,
		0x4180183F, 0x4B807926, 0, 0,
		&via_data[15], &via_data[16], 0xA47C2, 0xB3444, 0xB2C06, 0, 0xA71C0, 0x2254
	},
	{
		// LC580 #1
		0xA80A8,
		...
		0x4180183F, 0x4B807926, 0, 0,
		&via_data[15], &via_data[16], 0xA47C2, 0xB3444, 0xB2C06, 0, 0xA71C0, 0x225A
	},
	{
		// LC580 #2
		0xA80F0,
		&motherboards[10], 9, 0x03D22, 0xA8834, 0xDC80, 0x5D, 13, 0x3FFF, 4, 1,
		0x4180183F, 0x4B807926, 0, 0,
		&via_data[15], &via_data[16], 0xA47C2, 0xB3444, 0xB2C06, 0, 0xA71C0, 0x225B
	},
	{
		// LC580 #3
		0xA8138,
		&motherboards[10], 9, 0x03D22, 0xA8834, 0xDC80, 0x5D, 13, 0x3FFF, 4, 1,
		0x4180183F, 0x4B807926, 0, 0,
		&via_data[15], &via_data[16], 0xA47C2, 0xB3444, 0xB2C06, 0, 0xA71C0, 0x2258
	},
	{
		// unknown
		0xA8912,
		&motherboards[12], 0, 0, 0, 0, 0xFD, 0, 0xFFFF, 1, 0,
		0, 0, 0, 0,
		nullptr, nullptr, 0, 0xB33D2, 0, 0, 0, 0
	},
};
