...
Sonora::Sonora(MODEL model) {
	...
	switch(model) {
	case MODEL::UNUSED1 : model_id = 0xA55A0000; break;
	case MODEL::LCIII : model_id = 0xA55A0001; break;
	case MODEL::LCIII_p : model_id = 0xA55A0003; break;
	case MODEL::UNUSED2 : model_id = 0xA55A2000; break;
	case MODEL::UNUSED3 : model_id = 0xA55A2001; break;
	case MODEL::UNUSED4 : model_id = 0xA55A2002; break;
	case MODEL::UNUSED5 : model_id = 0xA55A2003; break;
	}
	RAMBaseHost[0x78] = 'r';
	RAMBaseHost[0x79] = 'o';
	RAMBaseHost[0x7A] = 'm';
